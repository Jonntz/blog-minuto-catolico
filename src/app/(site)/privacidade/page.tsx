...
export default function PrivacidadePage() {
  return (
    <LegalShell titulo="Política de Privacidade" resumo={RESUMO}>
      <h2>Resumo</h2>
      <p>
        O Minuto Católico é um site de leitura. Não há cadastro, não há login e{" "}
        <strong>não usamos cookies de rastreamento nem publicidade
        comportamental</strong>. Os únicos dados pessoais que o site recebe de
        forma deliberada são o e-mail de quem se inscreve na newsletter.
      </p>
      ...
      <p>
        Duas informações são gravadas no armazenamento local do seu navegador e{" "}
        <strong>nunca são enviadas ao servidor</strong>:
      </p>
      <dl>
      ...
      <p>
        Como não são cookies e não saem do aparelho, não há o que consentir: são
        preferências suas, sob seu controle. Limpar os dados do site no
      ...
      <h2>3. Medição de audiência</h2>
      <p>
        Usamos Cloudflare Web Analytics, que mede páginas vistas e origem do
        acesso <strong>sem cookie e sem criar identificador persistente</strong>{" "}
        de visitante. Não há Google Analytics, pixel de rede social nem
        rastreador de terceiro neste site.
      </p>

      <h2>4. Conteúdo carregado de outros domínios</h2>
      <p>
      ...
      <h2>8. Como falar sobre os seus dados</h2>
      {PENDENTE.email ? (
        <p>
